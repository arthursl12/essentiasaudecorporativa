...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: 'A Bhruna é a origem da Essentia. Com formação em enfermagem do trabalho e vasta experiência em massoterapia aplicada ao ambiente corporativo, ela atua na linha de frente do cuidado com o colaborador — aliviando tensões musculares, prevenindo afastamentos por LER/DORT e construindo, na prática, programas de saúde que geram resultado mensurável nos indicadores de absenteísmo das empresas. É a profissional que o RH chama quando quer transformar bem-estar em dado.',
  ...
  },
  {
    ...
    bio: 'Roseli traz para o ambiente corporativo uma escuta que vai além do óbvio. Com especialização em neuropsicologia e saúde emocional, ela atua na identificação precoce do esgotamento profissional, no suporte a colaboradores em sobrecarga e na estruturação de ações preventivas contra o Burnout — antes que o afastamento aconteça. Seu olhar integra cognição, comportamento e emoção: entende como o estresse crônico afeta a atenção, a memória e a tomada de decisão no trabalho, e transforma esse diagnóstico em intervenções práticas para equipes e líderes. Para o RH, isso significa ter uma aliada técnica que fala a língua dos dados e a língua das pessoas.',
  ...
  },
  {
    ...
    bio: 'Arthur é o elo entre saúde corporativa e inteligência de negócios. Com formação em engenharia de controle e automação e especialização em SST, ele transforma dados de afastamento, sinistralidade e clima organizacional em diagnósticos precisos — e diagnósticos precisos em estratégias de prevenção que fazem sentido para a operação da empresa. É ele quem responde a pergunta que o diretor sempre faz: "Qual o retorno real desse investimento?"',
